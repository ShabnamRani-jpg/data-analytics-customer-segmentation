...
## Authors
- Original Author: Abhishek Chowdhury - [Github Profile](https://github.com/AbhishekGit-hash)
- Maintained by: Shabnam Rani

## About the Maintainer

This project is currently maintained by Shabnam Rani, a Business Analyst with 2+ years of experience in data analysis and process optimization. Shabnam specializes in translating complex business requirements into actionable insights using tools like Python, SQL, and Tableau.
